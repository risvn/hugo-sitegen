---
date: '2025-10-30T18:12:28+05:30'
draft: false
title: "rsvn's Blog"
...
Static blogs require minimal resources to host since their only job is to serve prebuilt HTML files on client requests — unlike dynamic pages, they’re lightweight and cache easily.
and with git hub pages i dont need even a server to host how awesome is that i can do this with out spending a ruppe :)

>“Sometimes we need to be reminded more than we need to be taught.”
>— Samuel Johnson

I’m a nobody — just someone interested in **computers**, **operating systems**, **web**, **servers**,**backend-systems**,**games**, and **low-level tech**.  
